...
const FAQ_ITEMS = [
  {
    ...
    a: 'Yes, SnapDown is 100% free forever. There are no subscriptions, hidden fees, or daily download limits.',
  },
  {
    q: 'Do I need to create an account or install an app?',
    a: 'No account, password, or software installation is required. Everything runs directly in your web browser.',
  },
  {
    q: 'Does it download TikTok videos without watermarks?',
    a: 'Yes! SnapDown extracts the clean, original video without the bouncing TikTok watermark.',
  },
  {
    q: 'Can I convert and download YouTube videos to MP3?',
    a: 'Yes, our engine extracts standalone high-bitrate MP3 audio from any supported video or music link.',
  },
  {
    q: 'Where are downloaded files saved on my device?',
    a: 'Files are saved directly to your default browser downloads folder (or Photos app / Files on mobile devices).',
  },
];

export default function App() {
  const route = window.location.pathname.replace(/\/+$/, '').toLowerCase();
  const platform = Object.keys(platformNames).find((key) => route.includes(key)) || (route === '/other' ? 'other' : null);
  ...
  const fetchData = useCallback(async (forcedUrl) => {
    ...
    if (!platform) {
      ...
      window.location.assign(`/${detected || 'other'}?url=${encodeURIComponent(clean)}`);
      return;
    }
  ...
  }, [history, notify, persist, saveHistory, url, platform]);

  useEffect(() => {
    if (platform && initialUrl && !data) {
  ...
  const currentPlatformName = platform && platformNames[platform] ? platformNames[platform] : null;
  ...
  return (
    <div className="app-shell">
      ...
      <div className={`mobile-drawer ${drawerOpen ? 'active' : ''}`}>
        ...
        <nav>
          <ul>
            <li><a href="/#home" className="drawer-link" onClick={() => setDrawerOpen(false)}>Home</a></li>
            <li><a href="/#features" className="drawer-link" onClick={() => setDrawerOpen(false)}>Features</a></li>
            <li><a href="/#how-it-works" className="drawer-link" onClick={() => setDrawerOpen(false)}>How It Works</a></li>
            <li><a href="/youtube-video-downloader" className="drawer-link" onClick={() => setDrawerOpen(false)}>YouTube</a></li>
            <li><a href="/tiktok-video-downloader" className="drawer-link" onClick={() => setDrawerOpen(false)}>TikTok</a></li>
            <li><a href="/facebook-video-downloader" className="drawer-link" onClick={() => setDrawerOpen(false)}>Facebook</a></li>
            <li><a href="/instagram-video-downloader" className="drawer-link" onClick={() => setDrawerOpen(false)}>Instagram</a></li>
            <li><a href="/#faq" className="drawer-link" onClick={() => setDrawerOpen(false)}>FAQ</a></li>
            <li><a href="/#about" className="drawer-link" onClick={() => setDrawerOpen(false)}>About</a></li>
          </ul>
        </nav>
      ...
      <header className="site-header">
        <div className="container header-inner">
            ...
            <ul>
              ...
              <li className="nav-dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><a href="/youtube-video-downloader">YouTube Downloader</a></li>
                  <li><a href="/tiktok-video-downloader">TikTok Downloader</a></li>
          ...
          <div className="header-actions">
            ...
            <a href="#home" className="btn-cta">Start Downloading</a>
            <button
      ...
      <section className="hero" id="home">
        <div className="container">
          <div className="hero-badge">
            ...
            <span>{currentPlatformName ? `${currentPlatformName} Downloader` : '100% Free · No Limits · No Watermark'}</span>
          </div>

          <h1>
            {currentPlatformName ? (
              <>
                Download <span className="grad-text">{currentPlatformName}</span> Videos
              </>
            ) : (
              <>
          ...
          <p className="hero-sub">
            {currentPlatformName
              ? `Save ${currentPlatformName} videos and audio to MP4 or MP3 in highest quality without watermarks.`
              : 'Save videos from YouTube, TikTok, Facebook, Instagram and X in HD, 1080p, 4K or MP3 audio.'}
          </p>
          ...
          <div className="tool-shell">
            <div className="search-wrapper">
              <div className="search-box">
                ...
                <input
                  ...
                  placeholder={
                    currentPlatformName
                      ? `Paste ${currentPlatformName} link here (e.g. https://${currentPlatformName.toLowerCase()}.com/...)`
            ...
            <div className="platform-strip">
              ...
              <div className="platform-icons">
                <a href="/youtube-video-downloader"><i className="fa-brands fa-youtube brand-yt" title="YouTube"></i></a>
                <a href="/tiktok-video-downloader"><i className="fa-brands fa-tiktok brand-tt" title="TikTok"></i></a>
                <a href="/facebook-video-downloader"><i className="fa-brands fa-facebook-f brand-fb" title="Facebook"></i></a>
                <a href="/instagram-video-downloader"><i className="fa-brands fa-instagram brand-ig" title="Instagram"></i></a>
                <a href="/other"><i className="fa-brands fa-x-twitter brand-x" title="X / Twitter"></i></a>
              </div>
            </div>
      ...
      <section className="section" id="features">
        <div className="container">
          <div className="section-head-center">
            <span className="eyebrow">Why SnapDown</span>
            <h2>Built for speed, not friction</h2>
            <p>Everything you need from a downloader, nothing you don't.</p>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>Links are processed in seconds so you get straight to your download.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon"><i className="fa-solid fa-film"></i></div>
              <h3>HD Quality</h3>
              <p>Grab the highest resolution available, from 360p up to 4K where supported.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon"><i className="fa-solid fa-droplet-slash"></i></div>
              <h3>No Watermark</h3>
              <p>Files download clean, exactly as the original creator uploaded them.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon"><i className="fa-solid fa-user-slash"></i></div>
              <h3>No Signup Needed</h3>
              <p>No account, no email, no app install. Paste a link and go.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon"><i className="fa-solid fa-music"></i></div>
              <h3>MP3 Audio Extraction</h3>
              <p>Pull just the audio track when you only need the sound, not the video.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon"><i className="fa-solid fa-mobile-screen-button"></i></div>
              <h3>Works on Any Device</h3>
              <p>Fully responsive - use it on your phone, tablet or desktop browser.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="how-steps">
            <div className="how-step">
              ...
              <h3>Copy Link</h3>
              <p>Copy the video URL from YouTube, TikTok, Facebook, Instagram or X.</p>
            </div>
            <div className="how-step">
              ...
              <h3>Paste Link</h3>
              <p>Paste the link into SnapDown search box and click Download.</p>
            </div>
            <div className="how-step">
              ...
              <h3>Save Media</h3>
              <p>Choose your format and resolution, then save the file directly to your device.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="platforms">
        <div className="container">
          ...
          <div className="platforms-grid">
            <a href="/youtube-video-downloader" className="platform-card card-yt">
              <i className="fa-brands fa-youtube"></i>
              <h4>YouTube</h4>
              <div className="platform-badges">
                <span className="mini-badge">Video</span>
                <span className="mini-badge">MP3</span>
                <span className="mini-badge">Shorts</span>
              </div>
            </a>
            <a href="/tiktok-video-downloader" className="platform-card card-tt">
              <i className="fa-brands fa-tiktok"></i>
              <h4>TikTok</h4>
              <div className="platform-badges">
                <span className="mini-badge">No Watermark</span>
                <span className="mini-badge">Audio</span>
              </div>
            </a>
            <a href="/facebook-video-downloader" className="platform-card card-fb">
              <i className="fa-brands fa-facebook-f"></i>
              <h4>Facebook</h4>
              <div className="platform-badges">
                <span className="mini-badge">Reels</span>
                <span className="mini-badge">HD</span>
              </div>
            </a>
            <a href="/instagram-video-downloader" className="platform-card card-ig">
            ...
            <a href="/other" className="platform-card card-x">
        ...
        <div className="container">
          <div className="about-inner">
            <div className="about-text">
              ...
              <p>SnapDown was built out of frustration with online downloaders that are cluttered with intrusive ads, broken links and hidden popups. We wanted something clean, reliable, and respectful of your privacy.</p>
      ...
      {/* YouTube Modal */}
      <div className={`yt-modal-overlay ${ytModal ? 'active' : ''}`} onClick={(e) => e.target === e.currentTarget && setYtModal(false)}>
        <div className="yt-modal-box">
          <button className="yt-modal-close" type="button" onClick={() => setYtModal(false)}>
            <i className="fa-solid fa-xmark"></i>
          </button>
          <div className="yt-modal-icon">
            <i className="fa-brands fa-youtube"></i>
          </div>
          <h3>Direct YouTube Link</h3>
          <p>Copy the direct download stream URL to paste into VLC or external download managers.</p>
          <div className="yt-link-row">
            <input className="yt-link-input" readOnly value={url} />
            <button
            ...
            >
              {copiedYt ? 'Copied!' : 'Copy'}
            </button>
          </div>
          <div className="yt-note">
            Tip: Press <kbd>Ctrl</kbd>+<kbd>V</kbd> in your downloader or media player.
          </div>
        </div>
      </div>
    </div>
